PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.config.ringtone2=Lattice.ogg \
    ...
    ro.mediatek.version.release=Primo_E10_S06_16072019 \
    ...
    ro.sagereal.storage.2gto4g=false \
    ro.sagereal_sales_tracker_support=1 \
    ro.setupwizard.mode=OPTIONAL \
    ro.sf.hwrotation=0 \
    ro.sim_me_lock_mode=0 \
    ro.sim_refresh_reset_by_modem=1 \
    ro.sr_ftest_fcamera=1 \
    ro.sr_ftest_gsensor=1 \
    ro.sr_ftest_psensor=1 \
    ro.sr_multisim_ringtone=1 \
    ro.sr_wifi_default_off=1 \
    ro.sys.sdcardfs=1 \
